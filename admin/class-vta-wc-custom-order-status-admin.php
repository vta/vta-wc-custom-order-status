...
class Vta_Wc_Custom_Order_Status_Admin {
    ...
    public function setup_sections_new() {

	      // Order Status
        add_settings_section(
            'vta-wc-new-order-status',
            'Custom Order Status',
            array( Vta_Wc_Custom_Order_Status_Admin_Display::class, 'settings_section_new' ),
            'vta-new-fields'
        );
    ...
    public function setup_fields_new() {

	    add_settings_field(
	        'vta-wc-new-order-status-field',
            'New Order Status',
            array( Vta_Wc_Custom_Order_Status_Admin_Display::class, 'settings_field_new' ),
            'vta-new-fields',
            'vta-wc-new-order-status'
        );
