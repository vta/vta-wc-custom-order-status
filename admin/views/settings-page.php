...
?>
    ...
    <form action="<?php echo admin_url('admin-post.php'); ?>" method="post" id="reset-settings-form">
        ...
        <p class="description">
            <strong class="reset-warning">WARNING:</strong> Use this button to restore ALL custom order statuses and
            plugin
        ...
        <div id="reset-confirm-dialog" title="Reset Order Statuses">
            <p>
                ...
                Statuses will be reset to its original settings & all custom Order Statuses will be deleted.
                Are you sure?
            </p>
        </div>
    </form>

<?php if ( !empty($reorderable_statuses) ): ?>
    <hr>
...
<?php if ( !empty($reminder_statuses) ): ?>
    <hr>
